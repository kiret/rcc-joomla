...
class EasyDiscussViewIndex extends EasyDiscussView
{
	function display($tpl = null)
	{
		...
		// Get unread count
		$unreadCount 		= $model->getUnreadCount($categoryId, true);

		// Get unresolved count
		$unresolvedCount 	= $model->getUnresolvedCount( '', $categoryId, '', false );

		// Get unanswered count
		$unansweredCount 	= DiscussHelper::getUnansweredCount( $categoryId, true);
