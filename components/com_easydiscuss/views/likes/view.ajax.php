...
class EasyDiscussViewLikes extends EasyDiscussView
{
	...
	public function like()
	{
		...
		if( $post->isQuestion() && $isLike && $my->id != $post->user_id )
		{
			...
			DiscussHelper::getHelper( 'History' )->log( 'easydiscuss.like.discussion' , $my->id , JText::sprintf( 'COM_EASYDISCUSS_BADGES_HISTORY_LIKE_DISCUSSION' , $question->title ) );
