...
class EasyDiscussViewConversation extends EasyDiscussView
{
	...
	public function display( $tpl = null )
	{
		...
		$doc->setTitle( JText::_( 'COM_EASYDISCUSS_CONVERSATIONS_TITLE' ) );
	...
	public function archives()
	{
		...
		$doc 	= JFactory::getDocument();
		$doc->setTitle( JText::_( 'COM_EASYDISCUSS_CONVERSATIONS_ARCHIVE_TITLE' ) );
		...
		$theme->set( 'heading'			, JText::_( 'Archives' ) );
	...
	public function read()
	{
		...
		$doc->setTitle( JText::sprintf( 'COM_EASYDISCUSS_VIEW_CONVERSATION_TITLE' , $this->escape( $user->getName() ) ) );
