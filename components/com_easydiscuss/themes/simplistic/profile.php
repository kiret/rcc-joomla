				...
				<div class="discuss-user-social">
					...
					<div class="mt-10">
						<ul class="unstyled">
							...
							<li class="twitter"><a data-original-title="<?php echo JText::_('COM_EASYDISCUSS_TWITTER'); ?>" data-placement="top" rel="ed-tooltip" href="<?php echo DiscussStringHelper::escape($params->get( 'twitter' )); ?>" target="_blank"><i class="icon-ed-twitter"></i> <span><?php echo JText::_('COM_EASYDISCUSS_TWITTER'); ?></span></a></li>
							<?php } ?>
