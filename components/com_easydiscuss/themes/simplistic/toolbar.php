		...
		<div class="discuss-table">
			...
			<div class="discuss-tablecell discuss-searchbar--center">
				<div class=" discuss-searchbar--input">
					...
					<input type="text" class="placeholder input-searchbar" placeholder="<?php echo JText::_( 'COM_EASYDISCUSS_SEARCH_PLACEHOLDER' );?>" name="query" value="<?php echo $query ? $query : '';?>" />
			...
			<div class="discuss-tablecell discuss-searchbar--right">
				<a class="btn btn-primary btn-ask pull-left" href="<?php echo DiscussRouter::getAskRoute( $categoryId );?>"><?php echo JText::_( 'COM_EASYDISCUSS_OR_ASK_A_QUESTION' );?></a>
			</div>
			<?php } ?>
		</div>
	</div>
						...
						<div class="dropdown-menu dropdown-menu-medium loginDropDown">
							<form method="post" action="<?php echo JRoute::_( 'index.php' );?>">
								<ul class="discuss-login-menu unstyled">
									<li>
										<a tabindex="5" class="pull-right" href="<?php echo DiscussHelper::getRegistrationLink();?>"><?php echo JText::_( 'COM_EASYDISCUSS_REGISTER' );?></a>
										<label for="username" ><?php echo JText::_( 'COM_EASYDISCUSS_USERNAME' );?></label>
										<input type="text" tabindex="1" id="username" name="username" class="input full-width" size="18" autocomplete="off" />
									</li>
									<li>
										<a tabindex="6" class="pull-right" href="<?php echo DiscussHelper::getResetPasswordLink();?>"><?php echo JText::_( 'COM_EASYDISCUSS_FORGOT_PASSWORD' );?></a>
										<label for="discuss-toolbar-password"><?php echo JText::_( 'COM_EASYDISCUSS_PASSWORD' );?></label>

										<?php if( DiscussHelper::getJoomlaVersion() >= '1.6' ){ ?>
											<input type="password" tabindex="2" id="discuss-toolbar-password" class="input full-width" name="password" autocomplete="off" />
										<?php } else { ?>
											<input type="password" tabindex="2" id="discuss-toolbar-password" class="input full-width" name="passwd" autocomplete="off" />
										<?php } ?>
									</li>
									<li>
										<span class="pull-left">
											<input type="checkbox" tabindex="3" id="remember" name="remember" class="checkbox pull-left mr-5" value="yes" />
											<label for="remember" class="pull-left"><?php echo JText::_( 'COM_EASYDISCUSS_REMEMBER_ME' );?></label>
										</span>
										<input type="submit" tabindex="4" value="<?php echo JText::_( 'COM_EASYDISCUSS_LOGIN' , true);?>" name="Submit" class="btn btn-primary pull-right" />
									</li>
								</ul>
								<?php if( DiscussHelper::getJoomlaVersion() >= '1.6' ){ ?>
								<input type="hidden" value="com_users"  name="option">
