			...
			<form method="post" action="<?php echo JRoute::_( 'index.php' );?>">
				<ul class="discuss-login-menu unstyled">
					<li>
						...
						<input type="text" tabindex="1" id="discuss-post-username" name="username" class="input full-width" size="18" autocomplete="off" />
					</li>
					<li>
						...
						<?php if( DiscussHelper::getJoomlaVersion() >= '1.6' ){ ?>
							<input type="password" tabindex="2" id="discuss-post-password" class="input full-width" name="password" autocomplete="off" />
						<?php } else { ?>
							<input type="password" tabindex="2" id="discuss-post-password" class="input full-width" name="passwd" autocomplete="off" />
						<?php } ?>
					</li>
					<li>
						<span class="pull-left">
							<label for="discuss-post-remember" class="checkbox">
								<input type="checkbox" tabindex="3" id="discuss-post-remember" name="remember" class="" value="yes" />
