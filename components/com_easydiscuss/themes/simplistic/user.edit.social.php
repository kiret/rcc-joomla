...
<div class="tab-item user-social">
	<div class="control-group mb-20 form-inline">
		...
		<div class="input-wrap">
			<input type="text" value="<?php echo $this->escape( $userparams->get( 'facebook' ) );?>" name="facebook" class="input width-350">
	...
	<div class="control-group mb-20 form-inline">
		...
		<div class="input-wrap">
			<input type="text" value="<?php echo $this->escape( $userparams->get( 'twitter' ) ); ?>" name="twitter" class="input width-350">
	...
	<div class="control-group mb-20 form-inline">
		...
		<div class="input-wrap">
			<input type="text" value="<?php echo $this->escape( $userparams->get( 'linkedin' ) ); ?>" name="linkedin" class="input width-350">
	...
	<div class="control-group mb-20 form-inline">
		<div class="input-label skype pb-10"><i class="icon-ed-skype"></i> <?php echo JText::_('COM_EASYDISCUSS_SKYPE'); ?></div>
		<div class="input-wrap">
			<input type="text" value="<?php echo $this->escape( $userparams->get( 'skype' ) ); ?>" name="skype" class="input width-350">
	...
	<div class="control-group mb-20 form-inline">
		...
		<div class="input-wrap">
			<input type="text" value="<?php echo $this->escape( $userparams->get( 'website' ) ); ?>" name="website" class="input width-350">
