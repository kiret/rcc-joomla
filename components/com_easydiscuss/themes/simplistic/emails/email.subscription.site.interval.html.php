...
<div style="display:inline-block;width:100%;padding-bottom:15px;margin-bottom:15px;border-bottom:1px solid #ddd">
	<img src="<?php echo $data['avatar'];?>" width="50" alt="Mark Lee" style="float:left;width:50px;height:auto;border-radius:3px;-moz-border-radius:3px;-webkit-border-radius:3px;" />
