...
<div class="discussPolls discuss-polls <?php echo $unique_poll_id; ?>">
				...
				<li class="pollAnswer pollAnswerItem-<?php echo $poll->id; ?>" data-id="<?php echo $poll->id; ?>">
					...
					<div class="progress progress-success progress-striped">
						...
						<span class="poll-count">
							<a class="voteCount" id="poll-count-<?php echo $poll->id;?>" href="javascript:void(0);"><?php echo $poll->count; ?> votes</a>
