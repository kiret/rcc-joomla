	...
	<div class="discussPolls field-polls">
		...
		<div class="pollForm">
			<div class="control-group">
				<input type="text" class="input-xxlarge" name="poll_question" placeholder="<?php echo JText::_( 'COM_EASYDISCUSS_POLL_QUESTION_PLACEHOLDER' , true ); ?>" value="<?php echo $pollQuestion ? $pollQuestion : '';?>" />
			</div>
			<div class="control-group">
				...
				<label class="checkbox">
					<input type="checkbox" class="input float-l" name="multiplePolls" value="1"<?php echo $pollMultiple ? ' checked="checked"' : '';?>/>
				...
				<?php if( $polls ){ ?>
					...
					<li class="pollAnswers mb-5">
						<div class="input-append">
							<input type="text" name="pollitems[]" class="input input-xlarge pollAnswerText" value="<?php echo $poll->value; ?>" />
