	...
	<div id="oHeader-inner" class="navbar-inner">
		...
		<div class="row">
			...
			<div id="oHeader-left" class="span3">
				<h1><a id="home-icon" title="<?php echo JText::_('NAVIGATOR_LABEL_HOME');?>" href="<?php echo JRoute::_('index.php?option=com_stream&view=company'); ?>">RCC</a></h1>
				<!--
			...
			<div class="nav-collapse">
				...
				<div id="navigation" class="span9">
					<ul class="nav clearfix pull-left">
						...
						<!-- discuss -->
							<li class="discuss<?php if($option == 'com_easydiscuss') { echo ' active'; } ?>">
								<a href="<?php echo JRoute::_('index.php?option=com_easydiscuss'); ?>">Discuss
									<span class="navigator-notice">
									...
									<div class="toolbar-note pos-a br-2" style="display:none;">
										<ul class="notify-items reset-ul" id="notification-items">
											<li class="loading-indicator"><i></i></li>
										</ul>
									</div>
									</span>
								</a>
