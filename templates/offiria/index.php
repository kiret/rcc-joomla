...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo $this->baseurl ?>/templates/<?php echo JText::_('CUSTOM_TEMPLATE');?>/css/override.css" />
				...
				<div id="sidebar-left" class="span3">
					...
					<div class="sidebar-left-inner blocks">
						...
						<div class="groups-listing joined">
							<h3 class="clearfix"><span><?php echo JText::_('COM_TEMPLATE_MY_GROUPS'); ?></span><a id="group-create" class="btn" href="#" onclick="S.groups.create(this);return false;"><span><?php echo JText::_('COM_STREAM_LABEL_CREATE_A_GROUP');?></span></a></h3>
							<?php
							// Only show list of groups if there is any
						...
						<?php offiria_list_groups($myFollowedGroups, JText::_('COM_TEMPLATE_FOLLOWED_GROUPS'),$groupIJoin, $groupIFollow); ?>
