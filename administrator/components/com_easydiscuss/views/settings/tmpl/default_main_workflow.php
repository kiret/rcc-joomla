			...
			<div id="option03" class="accordion-body collapse in">
				<div class="wbody">
					<div class="si-form-row">
						<div class="span5 form-row-label">
							<label>
								<?php echo JText::_( 'COM_EASYDISCUSS_SIGNATURE_VISIBILITY' ); ?>
							</label>
						</div>
						<div class="span7"
							rel="ed-popover"
							data-placement="left"
							data-original-title="<?php echo JText::_( 'COM_EASYDISCUSS_SIGNATURE_VISIBILITY' ); ?>"
							data-content="<?php echo JText::_('COM_EASYDISCUSS_SIGNATURE_VISIBILITY_NOTICE'); ?>"
						>
