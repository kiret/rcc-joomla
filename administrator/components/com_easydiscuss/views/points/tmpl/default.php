	...
	<table class="table table-striped table-discuss">
		<thead>
			<tr>
				...
				<th width="20%" class="center"><?php echo JHTML::_('grid.sort', JText::_('Date'), 'a.created', $this->orderDirection, $this->order ); ?></th>
				<th width="6%" class="center"><?php echo JHTML::_('grid.sort', 'ID', 'a.id', $this->orderDirection, $this->order ); ?></th>
			</tr>
		</thead>
		<tbody>
		<?php
