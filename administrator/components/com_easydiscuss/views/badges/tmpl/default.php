		...
		<thead>
			<tr>
				...
				<th class="title" style="text-align: left;">
					<?php echo JHTML::_('grid.sort', 'Title', 'a.title', $this->orderDirection, $this->order ); ?>
				</th>
				...
				<th width="10%" nowrap="nowrap" style="text-align: center;">
					<?php echo JHTML::_('grid.sort', 'Date', 'a.created', $this->orderDirection, $this->order ); ?>
				</th>
				<?php } ?>

				<th width="6%" class="center" style="text-align:center;">
					<?php echo JHTML::_('grid.sort', 'ID', 'a.id', $this->orderDirection, $this->order ); ?>
				</th>
			</tr>
		</thead>
		<tbody>
