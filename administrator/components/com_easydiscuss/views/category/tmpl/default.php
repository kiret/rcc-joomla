	...
	if( items != null )
	{
		for(i = 0; i < items.length; i++)
		{
			...
			if( doinsert )
			{
				...
				discussQuery('#category_acl_' + type + '_' + action)
					.append(
						input
					);
			}
...
<ul class="nav nav-tabs">
	<li class="active"><a href="#si-option1" data-foundry-toggle="tab">General</a></li>
	<li><a href="#si-option2" data-foundry-toggle="tab">Permission</a></li>
</ul>
